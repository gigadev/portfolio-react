  ...
  return (
    <div className="bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 min-h-screen text-gray-100 py-12 px-4">
      <div className="max-w-3xl mx-auto bg-gray-900/70 border border-blue-800/40 p-8 rounded-xl shadow-xl">
        ...
        <p className="mb-4">I'm Scott Shepherd, a software architect and full-stack engineer with 25+ years of experience, including enterprise work for Hewlett-Packard, UL Solutions, The Princeton Review, and H&amp;R Block / RedGear. I build SaaS products and progressive web apps that give small and mid-sized businesses enterprise-grade software&mdash;without the enterprise overhead.</p>
        ...
        <p className="mb-6">Lately that means a multi-tenant CRM platform now in beta with its first customer, an AI-powered LinkedIn-native CRM in production, and a set of live working prototypes&mdash;an operations SaaS for short-term rental hosts, a municipal stormwater-compliance platform, and offline-first PWAs&mdash;built across the modern web (Next.js, TypeScript, Laravel) with deep Microsoft (.NET, Azure) experience to draw on. All delivered with Claude AI coding agents under senior-architect direction.</p>
